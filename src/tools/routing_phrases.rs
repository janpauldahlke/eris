...
pub fn fallback_triggers(tool_name: &str) -> &'static str {
    match tool_name {
        ...
        "memory:query" => "remembering, recalling, do you remember, what did I say, past conversations, search memory, who am I, what is my name, user name, my identity, preferences, facts about the user, recall, recognize me, history, look up contact, stored email address, email in memory, before sending email, before I mail, find their email, multi-step reminder, after the alarm, synthesis notes, 30_Synthesis, long-term recall, vector memory",
        ...
        "agenda:push" => "adding tasks, to-do list, add to agenda queue, schedule, plan, new task without setting a time, queue work, background task, add to my list, track this for later",
        ...
        "agenda:remind_at" => "remind me at, remind me in, remind me about, remind me tomorrow, remember to, nudge me at, ping me at, todo reminder, snooze task, alarm for my task, at 3pm for this, on my agenda, on my todo list, task_id reminder, in two minutes, in 2 minutes, multi-step task, several steps later, then send email, remind yourself to, delayed checklist",
        ...
        "ephemeral:buffer_query" => "search inside staged buffer, keyword query large file chunks, find section in buffered vault or web fetch, HITL chapter lookup, snippet search by buffer_id",
        "ephemeral:buffer_page" => "read next page of large vault file buffer, paginate staged blob, continue reading the file, next section of the note, read more of the document, rest of the file, keep going, sequential chunks after vault read or web fetch buffer_id",
