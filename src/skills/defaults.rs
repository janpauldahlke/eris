pub const MAIL_RECIPIENT_VERIFY_RAW: &str = include_str!("defaults/mail-recipient-verify.md");
pub const DB_CONNECTIONS_RECOVERY_RAW: &str = include_str!("defaults/db-connections-recovery.md");
pub const SKILL_AUTHORING_META_RAW: &str = include_str!("defaults/skill-authoring-meta.md");
pub const AGENDA_SELF_LOOP_RAW: &str = include_str!("defaults/agenda-self-loop.md");
pub const VAULT_ORIENTATION_RAW: &str = include_str!("defaults/vault-orientation.md");
pub const WEB_FETCH_WORKFLOW_RAW: &str = include_str!("defaults/web-fetch-workflow.md");
pub const MEDIA_CATALOG_WORKFLOW_RAW: &str = include_str!("defaults/media-catalog-workflow.md");
pub const TOOL_CATALOG_ORIENTATION_RAW: &str = include_str!("defaults/tool-catalog-orientation.md");
