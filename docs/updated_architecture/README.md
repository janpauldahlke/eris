...
| [03_ENGINE_LLM_AND_ROUTING.md](./03_ENGINE_LLM_AND_ROUTING.md) | `LlmEngine` (Ollama + LlamaCpp + OpenRouter), `EmbeddingProvider`, GBNF grammar compiler, JSON-schema structured output, ToolRouter |
